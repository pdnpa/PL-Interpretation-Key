...
status: draft
description: >
  Loose rocks and broken rock fragments that accumulate near the base of mountains, cliffs hillsides following weathering and erosion.
subclasses: []
associated_habitats:
