...
status: draft
description: >
  Areas of basic soils where primarily grasses and herbs grow. These soils are derived from the weathering of base-rich rocks and types of limestone, including chalk.
subclasses: []
---
