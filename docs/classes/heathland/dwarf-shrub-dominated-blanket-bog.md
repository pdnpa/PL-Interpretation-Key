...
status: draft
description: >
  Predominantly inactive bog areas. Dwarf shrub cover - including Heather and heath species (Calluna vulgaris and Erica spp.) – exceeds 75% of the canopy, and mosses (e.g. Sphagnum) are extremely rare if not completely absent.
subclasses: []
---
