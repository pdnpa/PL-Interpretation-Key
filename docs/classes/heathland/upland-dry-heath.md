...
status: draft
description: >
  Generally found in areas with low nutrient, acidic to circumneutral soils, which drain freely. Heather (Calluna vulgaris) and heath (Erica spp.) dominated, with other dwarf shrubs including Bilberry (Vaccinium spp.) and Crowberry (Empetrum nigrum).
subclasses: []
---
