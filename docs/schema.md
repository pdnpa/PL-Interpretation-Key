...
Click any code to view detailed guidance and examples.
...
| [a3](classes/a/a3.md) | Open mosaic | u1a | Habitat found on previously disturbed or industrial land (brownfields) featuring a mix of bare ground, sparse vegetation (grasses, wildflowers, mosses), and sometimes pools, creating rich areas for rare invertebrates (insects) and reptiles |
...
| [b3](classes/b/b3.md) | Orchards | c1 | Collections of fruit and/or nut producing trees, currently managed for food production, with an intensely managed ground cover. |
...
| [c1b](classes/c/c1.md) | Hedgerow trees (broadleaved) | w1g6 | Trees (broadleaved) within hedges, either single or lines. |
| [c2](classes/c/c2.md) | Coniferous woodland | w2 | Areas dominated by trees >5m tall. There must be a tree canopy cover of at least ???%, with ≥???% consisting of coniferous species. The majority of coniferous woodlands in the UK are from planted seedlings. Easily recognisable in aerial imagery, as plantations consist of uniformly aged, coloured and spaced trees, often with defined borders. |
| [c2a](classes/c/c2.md) | Single trees (coniferous) | w2 | Isolated, coniferous trees outside woodland. Only includes individual trees; as soon as there are more than one it must be classed as c1. |
| [c2b](classes/c/c2.md) | Hedgerow trees (coniferous) | w1g6 | Trees (coniferous) within hedges, either single or lines. |
| [c4](classes/c/c4.md) | Traditional orchard | BNG21 | Collections of fruit and/or nut producing trees, with low intensity management. The trees are found in more herbaceous ground cover than in an intensive orchard, and this category includes historical or abandoned orchards that still retain their trees. |
| [c5](classes/c/c5.md) | Clear felled/newly planted | BNG53 | Areas of woodland that have been recently felled or planted with new, young trees. Evidence of logging, rowing up of trash and drainage may be present. Newly planted trees can be identified by lines of uniform planting. |
...
| [s1b](classes/s/s1.md) | Gorse | h3e | Areas are covered by at least ???% Gorse. European Gorse (Ulex europaeus) dominates; Dwarf Gorse (Ulex minor) and Western Gorse (Ulex gallii) may also be present. Appears dark green, or is a distinct bright yellow when flowering. |
| [s2](classes/s/s2.md) | Hedgerows | h2 | Lines of shrubs <???m wide and <???m tall. Even though some species within the hedgerow may be capable of growing taller into trees, their shorter nature in this context results in the linear feature appearing as a ‘shrubby’ hedgerow. Often found at the boundaries of fields or bordering roads. |
...
| [e1b](classes/e/e1.md) | Upland acid grassland | g1b | Grassland that is found on acidic soils on top of sandstones and igneous rocks, typically above 300m in altitude. |
| [e2](classes/e/e2.md) | Calcareous grassland | g2 | Areas of basic soils where primarily grasses and herbs grow. These soils are derived from the weathering of base-rich rocks and types of limestone, including chalk. |
| [e3](classes/e/e3.md) | Neutral grassland | g3 | Areas of neutral soils (usually pH 4.5-6.5) where primarily grasses and herbs grow. |
| [e4](classes/e/e4.md) | Modified grassland | g4 | Areas of fertile, neutral soils where species-poor vegetation dominates. Modified grassland is often found on agricultural land that is intensively managed for grazing and/or fodder production. |
| [e5](classes/e/e5.md) | Arable field margins | c1 | Lines or sections of vegetation around arable fields, intended as beneficial for wildlife. |
...
| [f2](classes/f/f2.md) | Saltmarsh | t2a | Covers the area of land between where pioneer saltmarsh species start on mudflats, up to mature marsh. Nearest the shoreline vegetation which can survive frequent inundation is found, whereas at the transitional zone near the upper saltmarsh, only species which can survive occasional inundation are found. |
| [f3](classes/f/f3.md) | Peat bog | f1 | Areas where there is the permanent or frequent periodic presence of water, leading to waterlogged habitats with peat formation. Key indicator species include Sphagnum mosses. |
...
| [g3](classes/g/g3.md) | Unconsolidated bare ground | s3 | Ground types that are not fixed and can move around, such as loose sand, shingle or mud. Vegetation cover is sparse, as it is difficult for plants to root in unstable ground. |
| [g3a](classes/g/g3.md) | Sand | s3 | Fine grains of rocks and minerals. Typically found coastally or by water systems. |
| [g3b](classes/g/g3.md) | Mud | s3 | Clay/silt/fine sediments of earth and rocks mixed with water. Found near water. |
| [g3c](classes/g/g3.md) | Shingle | s3 | Coarse fragments of rock, such as pebbles, rounded by the erosion of water. Typically found coastally or by water systems. |
| [g4d](classes/g/g4.md) | Exposed peat | f1a6 | Areas where Sphagnum mosses have disappeared and the bog has dried up, leaving bare peat as the dominant cover type. |
| [g4](classes/g/g4.md) | Walls | s67 | A wall consisting of stones without mortar or cement. |
| [g5](classes/g/g5.md) | Scree | s1a | Loose rocks and broken rock fragments that accumulate near the base of mountains, cliffs hillsides following weathering and erosion. |
...
| [h3](classes/h/h3.md) | Vegetated shingle | s3b | Areas of shingle along the coastline that can support vegetation. This habitat is typically found above the mean high water spring tides and includes species such as: sea kale (Crambe maritima) and sea pea (Lathyrus japonicus). |
